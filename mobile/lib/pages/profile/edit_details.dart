...
typedef OnSaveHandler = void Function(Function closeDialog, String name,
    String email, String phone, String gender, String description);

enum Gender { male, female }

class EditDetails extends StatefulWidget {
  static void open(
      BuildContext context, UserSchema user, OnSaveHandler onSave) {
    showDialog(
      context: context,
...
class _EditDetailsState extends State<EditDetails> {
  ...
  void saveOnPressed() {
    ...
    widget.onSave(widget.onClose, nameController.text, emailController.text,
        phoneController.text, genderAsText, descriptionController.text);
  }
